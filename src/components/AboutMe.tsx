  ...
  return (
    <div className='flex flex-col justify-center items-center mt-[100px] transition-all duration-500' style={{gap: '1rem'}}>
        <div className='flex justify-center'>
            ...
            className={`w-[250px] px-2 pt-2 pb-8 h-fit bg-white rounded-sm -rotate-12 shadow-md transition-all duration-500 hover:w-[280px] hover:-rotate-[20deg]`}>
            ...
            <div 
            style={{transitionDelay: '100ms'}}
            className={`w-[250px] px-2 pt-2 pb-8 h-fit bg-white rounded-sm rotate-12 shadow-xl transition-all duration-500 hover:w-[280px] hover:rotate-[24deg]`}>
            ...
            <div 
            style={{transitionDelay: '100ms'}}
            className={`w-[250px] px-2 pt-2 pb-8 h-fit bg-white rounded-sm rotate-12 shadow-2xl transition-all duration-500 hover:w-[280px] hover:rotate-[25deg]`}>
